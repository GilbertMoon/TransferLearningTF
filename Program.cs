...
namespace TransferLearningTF
{
    class Program
    {
        ...
        static readonly string _assetsPath = Path.Combine(Environment.CurrentDirectory, "assets2");
        static readonly string _imagesFolder = Path.Combine(_assetsPath, "images_co");
        static readonly string _trainTagsTsv = Path.Combine(_imagesFolder, "0_tags.tsv");
        static readonly string _testTagsTsv = Path.Combine(_imagesFolder, "0_test-tags.tsv");
        static readonly string _predictSingleImage = Path.Combine(_imagesFolder, "C_T_01.jpg");
        static readonly string _inceptionTensorFlowModel = Path.Combine(_assetsPath, "inception", "tensorflow_inception_graph_covid.pb");
        // </SnippetDeclareGlobalVariables>

        static void Main(string[] args)
        {
            //Load model and weight
            //var loaded_model = Sequential.ModelFromJson(File.ReadAllText(@"c:\model\covid19model.json"));
            //loaded_model.LoadWeight(@"c:\model\covid19.model");
